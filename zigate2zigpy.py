...
def create_db(cursor):
    tables = ['CREATE TABLE IF NOT EXISTS attributes (ieee ieee, endpoint_id, cluster, attrid, value)',
              'CREATE TABLE IF NOT EXISTS clusters (ieee ieee, endpoint_id, cluster)',
              'CREATE TABLE IF NOT EXISTS devices (ieee ieee, nwk, status)',
              ('CREATE TABLE IF NOT EXISTS endpoints (ieee ieee, endpoint_id, profile_id, '
               'device_type device_type, status)'),
              ...
              ('CREATE TABLE IF NOT EXISTS node_descriptors (ieee ieee, value, FOREIGN KEY(ieee) '
    ...
    indexes = ['CREATE UNIQUE INDEX IF NOT EXISTS attribute_idx ON attributes(ieee, endpoint_id, cluster, attrid)',
